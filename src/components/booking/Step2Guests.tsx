...
import { ContinueFromGuestsButton } from './buttons/ContinueFromGuestsButton';
      ...
      <div className="card-nature p-6 space-y-6">
        ...
        <div className="pt-4 text-center">
          <p className="text-muted-foreground">
            {t('booking.step2.campsiteRate')}: <span className="font-semibold text-forest">{formatDualPriceInt(PRICING.campsitePerPersonPerNight, t('price_range_connector'))} {t('booking.priceTypes.personNight')}</span>
          </p>
        </div>
      </div>
              ...
              >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1">
                      ...
                      <p className="font-bold text-forest text-left sm:text-right">{formatDualPriceInt(tent.pricePerNight, t('price_range_connector'))} {t('accommodations.perNight')}</p>
                    </div>
