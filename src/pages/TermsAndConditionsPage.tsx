          ...
          >
            ...
            <div className="space-y-10">
              {sections.map((section, index) => {
                const listKey = `termsAndConditions.sections.${section}.list`;
                ...
                return (
                  ...
                  >
                    <h2 className="text-xl font-semibold text-foreground mb-3 font-heading">
                      {t(`termsAndConditions.sections.${section}.title`)}
                    </h2>
                    <p className="text-muted-foreground leading-relaxed">
                      {t(`termsAndConditions.sections.${section}.content`)}
                    </p>
